        ...
        <br>
          ...
          <div class="col mr-2">
             <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">공지사항 시작일</div>
              <input type="text" id="startDate" name="start_date" class="form-control" value="${noticedetail.start_date }"><br>
          </div>
          <div class="col mr-2">
             <div class="text-xs font-weight-bold text-primary text-uppercase mb-1" >공지사항 종료일</div>
              <input type="text" id="endDate" name="end_date" class="form-control" value="${noticedetail.end_date }"><br>
          </div>
