...
<script src='/js/js.js?1581498080'></script>
<!-- AMP Analytics -->
...
<!----------------------비회원의 경우 표시-------------------------->
<form method="get" name="o_search" >
<input type=hidden name="guest_search" value="y">
	<tr>
		<td align="center" colspan="2">
			<table cellpadding="0" cellspacing="0" border="0" align="center" width="1200">
				<tr>
					<td align="center">
<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 13pt; color:#000;">주문 번호　<input name="s_oid" type="text" style="background: #f9f9f9; BORDER: #f9f9f9 1px solid; max-width: 250px; width: 100%; height:30px; text-indent: 10;" placeholder="입력"></span>
					</td>
				</tr>
				<tr>
					<td align="center">
<a href="javascript:document.o_search.submit()"><span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 13pt; color:#000;"><br>조회하기</span></a>
					</td>
				</tr>
			</table>
		</td>
	...
	<tr>
		<td align="center" colspan="2">
			...
			<table cellpadding="0" cellspacing="0" border="0" align="center" width="95%">
				...
				<tr>
					<td align="center">
<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 20pt; color:#000;">주문 조회</span>
					</td>
				</tr>
				<tr>
					<td height="50"></td>
...
<!----------------------비회원의 경우 표시-------------------------->
						<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
							<form method="get" name="o_search_m" >
							<input type=hidden name="guest_search" value="y">
							<tr>
								<td align="center">
			<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 10pt; color:#000;">주문 번호　<input name="s_oid" type="text" style="background: #f9f9f9; BORDER: #f9f9f9 1px solid; max-width: 150px; width: 100%; height:30px; text-indent: 10;" placeholder="입력"></span>
								</td>
							</tr>
							<tr>
								<td align="center">
			<a href="javascript:document.o_search_m.submit()"><span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 13pt; color:#000;"><br>조회하기</span></a>
								</td>
							</tr>
							</form>
						</table>
