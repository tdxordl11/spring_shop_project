...
<meta property="og:url" content="http://www.schezade.co.kr/member/member_modi.html">
...
<link rel="canonical" href="http://www.schezade.co.kr/member/member_modi.html">
...
<script src='/js/js.js?1581481614'></script>
<!-- AMP Analytics -->
...
function id_existence_check()  {
	var userid = '';
	userid = document.register.id.value;
	if (userid=='') { 
    window.alert('확인할 아이디를 입력해주세요.');
    document.register.id.focus();
  return false;
	}
	else if (userid.length<4 || userid.length>8) {
	 window.alert('4~8자의 영문,숫자만 입력해 주세요');
   document.register.id.focus();
	}
	else {
	var url='member_id_check.html?id=' + userid;
	browsing_window = window.open(url, 'check_id_box','height=120,width=230, menubar=no,directories=no,resizable=no,status=no,scrollbars=yes');
	}
}


function search_zip()  {
	winzip= window.open("/etc_html/zip_search.html?form_name=register&zip1_name=zipcode1&zip2_name=zipcode2&address_name=address","zip_search","scrollbars=no,resizable=no,width=580,height=350,left=210,top=130");
	winzip.focus();
}
...
<table cellpadding="0" cellspacing="0" align="center" border="0" width="100%">
	...
	<tr>
		<td align="center"><span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 20pt; color:#000;">회원 수정</span>
<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 13pt; color:#000;"><br>Modify Account</span></td>
	</tr>
</table>
...
<form  name="register" method=post action='member_modi_ps.html'  onsubmit="return check();">
<input type=hidden name=no value='82007'>
	<tr>
		<td height="50"></td>
	</tr>
	<tr>
        ...
        <div class="grid_17">
			<table cellpadding="0" cellspacing="0" align="center" border="0" width="100%" height="50" bgcolor="f5f5f5">
				<tr>
					<td width="10%"></td>
					<td>
						<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 10pt; color:#000;">아이디</span>
					</td>
				</tr>
			</table>
		</div>
        ...
        <div class="grid_18">
			<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0" height="150" bgcolor="f9f9f9">
				<tr>
					<td width="10%"></td>
					<td>
<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 10pt; color:#959595;"><input name="zipcode" id="zipcode" value="08767" type="text" style="background: #f9f9f9; BORDER: #f9f9f9 1px solid; max-width: 150px; width: 100%; height:30px;" placeholder="우편번호"></span><a href="javascript:zip('zipcode','address','address_ADD')"><span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 9pt; color:#ff0000;">　주소 검색</span></a>
					</td>
				</tr>
				<tr>
					<td width="10%"></td>
					<td>
<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 10pt; color:#959595;"><input name="address" id="address"  value="서울 관악구 신림동 530-9" maxlength=200 type="text" style="background: #f9f9f9; BORDER: #f9f9f9 1px solid; max-width: 200px; width: 100%; height:30px;" placeholder="주소"></span>
					</td>
				</tr>
				<tr>
					<td width="10%"></td>
					<td>
<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 10pt; color:#959595;"><input  name="address_ADD" id="address_ADD"  value="503호"  maxlength=300 type="text" style="background: #f9f9f9; BORDER: #f9f9f9 1px solid; max-width: 200px; width: 100%; height:30px;" placeholder="상세주소"></span>
					</td>
				</tr>
			</table>
		</div>
        ...
        <div class="grid_18">
			<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0" height="50" bgcolor="f9f9f9">
				<tr>
					<td width="10%"></td>
					<td>
<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 10pt; color:#959595;"><input name="cellpager1" value='010'  maxlength=4 type="text" style="background: #f9f9f9; BORDER: #f9f9f9 1px solid; max-width: 80px; width: 100%; height:30px;" placeholder="01X"></span>&nbsp;-&nbsp;
<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 10pt; color:#959595;"><input name="cellpager2" value='6540'  maxlength=4 type="text" style="background: #f9f9f9; BORDER: #f9f9f9 1px solid; max-width: 80px; width: 100%; height:30px;" placeholder="1234"></span>&nbsp;-&nbsp;
<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 10pt; color:#959595;"><input name="cellpager3" value='6225'  maxlength=4 type="text" style="background: #f9f9f9; BORDER: #f9f9f9 1px solid; max-width: 80px; width: 100%; height:30px;" placeholder="5678"></span>
					</td>
				</tr>
			</table>
		</div>
        ...
        <div class="grid_18">
			<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0" height="50" bgcolor="f9f9f9">
				<tr>
					<td width="10%"></td>
					<td>
<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 10pt; color:#959595;"><input name="hometel1" value='' maxlength=4 type="text" style="background: #f9f9f9; BORDER: #f9f9f9 1px solid; max-width: 80px; width: 100%; height:30px;" placeholder=""></span>&nbsp;-&nbsp;
<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 10pt; color:#959595;"><input name="hometel2" value='' maxlength=4 type="text" style="background: #f9f9f9; BORDER: #f9f9f9 1px solid; max-width: 80px; width: 100%; height:30px;" placeholder=""></span>&nbsp;-&nbsp;
<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 10pt; color:#959595;"><input name="hometel3" value='' maxlength=4 type="text" style="background: #f9f9f9; BORDER: #f9f9f9 1px solid; max-width: 80px; width: 100%; height:30px;" placeholder=""></span>
					</td>
				</tr>
			</table>
		</div>
	...
	<tr>
		<td>
        <div class="grid_17">
			<table cellpadding="0" cellspacing="0" align="center" border="0" width="100%" height="100" bgcolor="f5f5f5">
				<tr>
					<td width="10%"></td>
					<td>
<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 10pt; color:#000;">사이버 머니 </span>
					</td>
				</tr>
			</table>
		</div>
        <div class="grid_18">
			<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0" height="100" bgcolor="f9f9f9">
				<tr>
					<td width="10%"></td>
					<td>

<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 10pt; color:#000;">0원</span>
<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 9pt; color:#000;"><br><br>※세일샵, 역경매샵, 전시개봉품샵에서는 사용불가</span>
					</td>
				</tr>
			</table>
		</div>
        ...
        <div class="grid_17">
			<table cellpadding="0" cellspacing="0" align="center" border="0" width="100%" height="100" bgcolor="f5f5f5">
				<tr>
					<td width="10%"></td>
					<td>
<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 10pt; color:#000;">사용 가능 쿠폰</span>
					</td>
				</tr>
			</table>
		</div>
...
<select>
<option>사용가능쿠폰</option>
</select>
</span>
<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 9pt; color:#000;"><br><br>※기간이 만료되었거나 사용이 불가한 쿠폰은 표시되지 않습니다.</span>
					</td>
				</tr>
			</table>
		</div>
...
<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 10pt; color:#959595;"><input name="mail" value='leeworld9@naver.com' maxlength=200 type="text" style="background: #f9f9f9; BORDER: #f9f9f9 1px solid; max-width: 200px; width: 100%; height:30px;" placeholder="이메일"></span>
					</td>
				</tr>
			</table>
		</div>
        ...
        <div class="grid_17">
			<table cellpadding="0" cellspacing="0" align="center" border="0" width="100%" height="50" bgcolor="f5f5f5">
				<tr>
					<td width="10%"></td>
					<td>
<span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 10pt; color:#000;">뉴스 수신 </span>
					</td>
				</tr>
			</table>
		</div>
...
<input name="mailing" type="radio" value=1 checked style="max-width: 15px; width: 100%; height:15px;" placeholder=""><span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 10pt; color:#000;">　수신</span>
					</td>
					<td width="70%" align="left">
<input name="mailing" type="radio" value=0   style="max-width: 15px; width: 100%; height:15px;" placeholder=""><span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 10pt; color:#000;" checked>　비수신</span>
					</td>
				</tr>
			</table>
		</div>
	...
	<tr>
		<td align="center" height="50" bgcolor="252525"><a href="javascript:ckform2();"><span style="font-family: Noto Sans KR, sans-serif; font-weight: 300; font-size: 15pt; color:#fff;">수정하기</span></a></td>
	</tr>
	<tr>
		<td height="30"></td>
	</tr>
...
<center>
<a href="/member/etc/member_delete.html"><img src='/images/member/delete.gif'></a>
</center>
<br>
<br><br><br>
<script src="/js/placeholder.js"></script>

<iframe name="member_join_ps" src="about:blank" width=0 height=0 frameborder=0></iframe>
