...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href='<%=request.getContextPath() +"/admin/main"%>'>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">cs관리 상세</h6>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><%=session.getAttribute("session") %> 님</span>
              </a>
        ...
        <!-- main code 작성 , style은 샘플파일 참고 -->
        <!--  ex) http://localhost:8081/shop_project/admin/main?menu=admin_manage -->
  ...
  <!-- Page level plugins -->
  <script src="<%=respath %>vendor/datatables/jquery.dataTables.min.js"></script>
  <script src="<%=respath %>vendor/datatables/dataTables.bootstrap4.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="<%=respath %>js/demo/datatables-demo.js"></script>
