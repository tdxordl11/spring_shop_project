...
//		  cart.add(vo);
	  ...
	  @RequestMapping(value = "/cart_view", method = RequestMethod.POST )
			public String cart_view(@ModelAttribute CartVO vo, HttpSession session) {
		  session.setAttribute("c_info", vo);
				return "cart_view";
			}
